...
from app.views.api_posts import PostListCreateAPIView
...
urlpatterns = [
    ...
    path('posts/<int:post_id>/curtir/', api_views.curtir_post_api, name='curtir_post_api'),
    path('posts/<int:post_id>/comentar/', api_views.comentar_post_api, name='comentar_post_api'),
    path('posts/<int:post_id>/comentarios/', api_views.listar_comentarios_api, name='listar_comentarios_api'),
]